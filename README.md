...
RashedGPT is an open-source **agentic AI chatbot** built with **Python, FastAPI, LangGraph, LangChain, Google Gemini, Tavily, ChromaDB, and SQLite**.
...
```bash
conda create -n rashedgpt python=3.11 -y
```

### 4. Activate the virtual environment

```bash
conda activate rashedgpt
```
...
```text
315865595366.dkr.ecr.us-east-1.amazonaws.com/rashedgpt
```
